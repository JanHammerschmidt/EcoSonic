...
static const TX_STRING InteractorId = (char*) "Twilight Sparkle";
 ...
 */
BOOL TobiiTracker::InitializeGlobalInteractorSnapshot(TX_CONTEXTHANDLE hContext)
{
 ...
 */
void TX_CALLCONVENTION TobiiTracker::OnSnapshotCommitted(TX_CONSTHANDLE hAsyncData, TX_USERPARAM /*param*/)
{
 ...
 */
void TX_CALLCONVENTION TobiiTracker::OnEngineConnectionStateChanged(TX_CONNECTIONSTATE connectionState, TX_USERPARAM /*userParam*/)
{
    ...
    case TX_CONNECTIONSTATE_CONNECTED: {
            ...
            success = txCommitSnapshotAsync(g_hGlobalInteractorSnapshot, &TobiiTracker::OnSnapshotCommitted, NULL) == TX_RESULT_OK;
            if (!success) {
 ...
 */
void TobiiTracker::OnGazeDataEvent(TX_HANDLE hGazeDataBehavior)
{
 ...
 */
void TX_CALLCONVENTION TobiiTracker::HandleEvent(TX_CONSTHANDLE hAsyncData, TX_USERPARAM /*userParam*/)
{
    ...
    if (txGetEventBehavior(hEvent, &hBehavior, TX_BEHAVIORTYPE_GAZEPOINTDATA) == TX_RESULT_OK) {
        assert(gTracker != nullptr);
        gTracker->OnGazeDataEvent(hBehavior);
...
bool TobiiTracker::StartTracker()
{
